...
var _TomCrypto$caret$Main$viewMessage = function (msg) {
	return A2(
...
var _TomCrypto$caret$Main$unpackOk = function (res) {
	var _p0 = res;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			...
			_p0)('unpackOk: Don\'t call this function on an Err!');
	}
};
var _TomCrypto$caret$Main$getGraphData = function () {
	var d3 = _elm_lang$core$Native_List.fromArray(
		[
	...
	var halfStepsTo14 = A2(
		_elm_lang$core$List$map,
		function (x) {
			return x / 2;
		},
		_elm_lang$core$Native_List.range(0, 28));
	var d1 = A2(
		_elm_lang$core$List$map,
		function (x) {
			return _elm_lang$core$Maybe$Just(
...
var _TomCrypto$caret$Main$messageTypeToString = function (t) {
	var _p2 = t;
	if (_p2.ctor === 'TestMessage') {
		return 'TestMessage';
	} else {
		return 'FaultMessage';
	}
};
var _TomCrypto$caret$Main$messageLayout = function (msg) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('message-table')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('message-source-icon-col')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												function () {
												...
												switch (_p3.ctor) {
													case 'WiFi':
														return A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$src('icons/wifi.png')
																]),
															_elm_lang$core$Native_List.fromArray(
																[]));
													case 'Satellite':
														return A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$src('icons/satellite.png')
																]),
															_elm_lang$core$Native_List.fromArray(
																[]));
													case 'GPRS':
														return A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$src('icons/gprs.png')
																]),
															_elm_lang$core$Native_List.fromArray(
																[]));
													default:
														return A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$src('icons/radio.png')
																]),
															_elm_lang$core$Native_List.fromArray(
																[]));
												}
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('message-received-date-col')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('message-type-col')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(
												_TomCrypto$caret$Main$messageTypeToString(
													function (_) {
														return _.mtype;
													}(msg)))
											]))
...
var _TomCrypto$caret$Main$view = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(_elm_lang$core$List$map, _TomCrypto$caret$Main$messageLayout, _p5.messages));
};
var _TomCrypto$caret$Main$graphData = _elm_lang$core$Native_Platform.outgoingPort(
	'graphData',
	function (v) {
...
var _TomCrypto$caret$Main$Message = F4(
	function (a, b, c, d) {
		return {source: a, received: b, mtype: c, data: d};
	});
var _TomCrypto$caret$Main$Model = function (a) {
	return {messages: a};
};
var _TomCrypto$caret$Main$init = {
	ctor: '_Tuple2',
	_0: _TomCrypto$caret$Main$Model(
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _TomCrypto$caret$Main$MessageHeader = F3(
	function (a, b, c) {
		return {source: a, received: b, mtype: c};
	});
var _TomCrypto$caret$Main$Radio = {ctor: 'Radio'};
var _TomCrypto$caret$Main$GPRS = {ctor: 'GPRS'};
var _TomCrypto$caret$Main$Satellite = {ctor: 'Satellite'};
var _TomCrypto$caret$Main$WiFi = {ctor: 'WiFi'};
var _TomCrypto$caret$Main$decodeMessageSource = function (str) {
	var _p6 = str;
	switch (_p6) {
		case 'WiFi':
			return _TomCrypto$caret$Main$WiFi;
		case 'Satellite':
			return _TomCrypto$caret$Main$Satellite;
		case 'GPRS':
			return _TomCrypto$caret$Main$GPRS;
		case 'Radio':
			return _TomCrypto$caret$Main$Radio;
		default:
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 80, column: 5},
					end: {line: 85, column: 58}
				},
				_p6)('Bad message source!');
	}
};
var _TomCrypto$caret$Main$FaultMessage = {ctor: 'FaultMessage'};
var _TomCrypto$caret$Main$TestMessage = {ctor: 'TestMessage'};
var _TomCrypto$caret$Main$decodeMessageType = function (str) {
	var _p8 = str;
	switch (_p8) {
		case 'TestMessage':
			return _TomCrypto$caret$Main$TestMessage;
		case 'FaultMessage':
			return _TomCrypto$caret$Main$FaultMessage;
		default:
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
				...
				_p8)('Bad message type!');
	}
};
var _TomCrypto$caret$Main$decodeHeader = function (str) {
	var header = _TomCrypto$caret$Main$unpackOk(
		A2(
			_elm_lang$core$Json_Decode$decodeString,
			A4(
				_elm_lang$core$Json_Decode$object3,
				_TomCrypto$caret$Main$MessageHeader,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'origin', _elm_lang$core$Json_Decode$string),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'received', _elm_community$json_extra$Json_Decode_Extra$date),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'type', _elm_lang$core$Json_Decode$string)),
			str));
	return {
		ctor: '_Tuple3',
		_0: _TomCrypto$caret$Main$decodeMessageSource(
			function (_) {
				return _.source;
			}(header)),
		_1: function (_) {
		...
		_2: _TomCrypto$caret$Main$decodeMessageType(
			function (_) {
				return _.mtype;
			}(header))
	};
};
var _TomCrypto$caret$Main$decodeMessage = function (str) {
	var _p10 = _TomCrypto$caret$Main$decodeHeader(str);
	var source = _p10._0;
	var date = _p10._1;
	var mtype = _p10._2;
	return {source: source, received: date, mtype: mtype, data: 'placeholder'};
};
var _TomCrypto$caret$Main$update = F2(
	function (msg, _p11) {
		var _p12 = _p11;
		var _p13 = msg;
		return {
			...
			_0: _TomCrypto$caret$Main$Model(
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_TomCrypto$caret$Main$decodeMessage(_p13._0)
						]))),
			_1: _TomCrypto$caret$Main$graphData(_TomCrypto$caret$Main$getGraphData)
		};
	});
var _TomCrypto$caret$Main$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _TomCrypto$caret$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080', _TomCrypto$caret$Main$NewMessage);
};
var _TomCrypto$caret$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _TomCrypto$caret$Main$init, view: _TomCrypto$caret$Main$view, update: _TomCrypto$caret$Main$update, subscriptions: _TomCrypto$caret$Main$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _TomCrypto$caret$Main$main === 'undefined' ? null : _TomCrypto$caret$Main$main);
